...
public class ResetPasswordModel : PageModel
{
    ...
    public ResetPasswordModel(UserManager<ApplicationUser> userManager) => this.userManager = userManager;
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        var result = await this.userManager.ResetPasswordAsync(user, this.Input.Code, this.Input.Password).ConfigureAwait(false);
        if (result.Succeeded)
        {
            return this.RedirectToPage("./ResetPasswordConfirmation");
        }
